...
if(edt1.Text = '') or (cbb1.Text = '') or (edt2.Text = '') or (edt3.Text = '') or (edt4.Text = '') or (edt5.Text = '')then
begin
  ShowMessage('DATA TIDAK BOLEH KOSONG !');
end else
if(zqry1.Locate('nama_cust',edt1.Text,[]))then
begin
  ShowMessage('Data customer sudah ada');
  posisiawal;
end else
begin
zqry1.sql.clear;
zqry1.sql.Add('insert into customer values(null,"'+edt1.Text+'","'+cbb1.Text+'","'+edt2.text+'","'+edt3.text+'","'+edt4.text+'","'+edt5.text+'")');
zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update customer set nama_cust= "'+edt1.Text+'", jenis_kelamin = "'+cbb1.Text+'", alamat = "'+edt3.Text+'", telp = "'+edt4.Text+'", id_jual = "'+cbb1.Text+'", id_barang = "'+edt5.Text+'" where id ="'+id+'"');
zqry1.ExecSQL;
