...
begin
zqry1.sql.clear;
zqry1.sql.Add('insert into detail_beli values(null,"'+edt1.Text+'","'+edt2.text+'","'+edt3.text+'","'+edt4.text+'","'+edt5.text+'","'+edt6.text+'")');
zqry1.ExecSQL;
...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update detail_beli set beli_id= "'+edt1.Text+'", barang_id = "'+edt2.Text+'", jumlah = "'+edt3.Text+'", harga_beli = "'+edt4.Text+'", total_beli = "'+edt5.Text+'", id_supplier = "'+edt6.Text+'" where id ="'+id+'"');
zqry1.ExecSQL;
